...
class ROLO_utils:
    ...
    def load_yolo3_output(self,w_img,h_img,foldf,foldb,batch_size, num_steps, id):    
...
def choose_video_sequence(test):
    #Human training
    if test == 0:
        w_img, h_img = [1280, 720] #Resolution
        ...
        w_img, h_img = [480, 270]
        sequence_name = 'Iceskater'
        step = 6
        training_iters = 500
        testing_iters = 500
    elif test == 6:
        w_img, h_img = [540, 360]
        sequence_name = 'person-4'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 7:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-5'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 8:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-6'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 9:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-11'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 10:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-1'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 11:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-16'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 12:
        w_img, h_img = [960, 720]
        sequence_name = 'person-13'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 13:
        ...
        w_img, h_img = [1280, 720]
        sequence_name = 'Motorbike_ce'
        step = 6
        training_iters = 563
        testing_iters = 563
    elif test == 15:
        w_img, h_img = [1280,720]
        sequence_name = 'Drone2'
        training_iters = 600
        testing_iters = 600
    elif test == 16:
        w_img, h_img = [1280, 720]
        sequence_name = 'person-8'
        step = 6
        training_iters = 900
        testing_iters = 900
    elif test == 17:
    ...
    #Human Testing
        ...
        w_img, h_img = [1280, 540]
        sequence_name = 'person-10'
        step = 6
        training_iters = 600
        testing_iters = 600
...
def choose_video_sequence(test):
    ...
    if test == 0:
        ...
        w_img, h_img = [720, 480]
        sequence_name = 'Basketball_ce2'
        step = 6
        training_iters = 455
        testing_iters = 455
    elif test == 4:
        w_img, h_img = [448, 336]
        sequence_name = 'Bike_ce2'
        step = 6
        training_iters = 812
        testing_iters = 812
    elif test == 5:
        ...
        w_img, h_img = [640, 480]
        sequence_name = 'Boat_ce1'
        step = 6
        training_iters = 377
        testing_iters = 377
    elif test == 7:
        w_img, h_img = [1280, 720]
        sequence_name = 'Busstation_ce1'
        step = 6
        training_iters = 363
        testing_iters = 363
    elif test == 8:
        w_img, h_img = [320, 240]
        sequence_name = 'Carchasing_ce1'
        step = 6
        training_iters = 501
        testing_iters = 501
    elif test == 9:
        w_img, h_img = [320, 240]
        sequence_name = 'Carchasing_ce3'
        step = 6
        training_iters = 572
        testing_iters = 572
    elif test == 10:
        ...
        w_img, h_img = [360, 240]
        sequence_name = 'Crossing'
        step = 6
        training_iters = 120
        testing_iters = 120
    elif test == 12:
        w_img, h_img = [320, 240]
        sequence_name = 'Eagle_ce'
        step = 6
        training_iters = 112
        testing_iters = 112
    elif test == 13:
        w_img, h_img = [1280, 720]
        sequence_name = 'Electricalbike_ce'
        step = 6
        training_iters = 818
        testing_iters = 818
    elif test == 14:
        w_img, h_img = [1280, 720]
        sequence_name = 'Hurdle_ce1'
        step = 6
        training_iters = 300
        testing_iters = 300
    elif test == 15:
        ...
        w_img, h_img = [640, 480]
        sequence_name = 'Plane_ce2'
        step = 6
        training_iters = 653
        testing_iters = 653
    elif test == 19:
        w_img, h_img = [1280, 720]
        sequence_name = 'Railwaystation_ce'
        step = 6
        training_iters = 413
        testing_iters = 413
    elif test == 20:
        w_img, h_img = [448, 336]
        sequence_name = 'Singer_ce1'
        step = 6
        training_iters = 214
        testing_iters = 214
    elif test == 21:
        w_img, h_img = [1280, 720]
        sequence_name = 'Skating_ce2'
        step = 6
        training_iters = 497
        testing_iters = 497
    elif test == 22:
        w_img, h_img = [640, 480]
        sequence_name = 'Skyjumping_ce'
        step = 6
        training_iters = 938
        testing_iters = 938
    elif test == 23:
        w_img, h_img = [1280, 720]
        sequence_name = 'Surf_ce2'
        step = 6
        training_iters = 391
        testing_iters = 391
    elif test == 24:
        w_img, h_img = [1280, 720]
        sequence_name = 'Surf_ce3'
        step = 6
        training_iters = 279
        testing_iters = 279
